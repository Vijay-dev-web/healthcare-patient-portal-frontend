const Home = () => {
  return (
    <div>
      ...
      <div className=" bg-green-600 text-white flex justify-center gap-4 font-bold text-sm py-2">
        <a href="#">Home</a>
      ...
      <div className="bg-gray-200 pt-16 px-10">
        ...
        <div className="flex gap-4 pb-8">
            <div className="bg-white w-64 p-4">
                ...
                <div className="text-sm pb-2">Stay informed about the latest COVID 19 guidelines and vaccination information</div>
                <button className="text-sm bg-green-600 text-white px-2 py-1">Learn More</button>
            </div>
            <div className="bg-white w-64 p-4">
                <h3 className="font-bold pb-2">COVID 19 Updates</h3>
                <div className="text-sm pb-2">Stay informed about the latest COVID 19 guidelines and vaccination information</div>
